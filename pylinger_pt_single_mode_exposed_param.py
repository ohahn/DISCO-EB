...
def model_synchronous(*, tau, yin, omegam, omegab, param, kmode, lmaxg, lmaxgp, lmaxr, lmaxnu, nqmax):
...
def adiabatic_ics( *, tau: float, omegam, omegab, param, kmodes, num_k, nvar, lmaxg, lmaxgp, lmaxr, lmaxnu, nqmax):
...
def evolve_one_mode( *, y0, tau_start, tau_max, tau_out, omegam, omegab, param, kmode, lmaxg, lmaxgp, lmaxr, lmaxnu, nqmax, rtol, atol ):
    ...
    model1 = diffrax.ODETerm( 
        lambda tau, y , params : 
            model_synchronous( omegam=params, omegab=omegab, tau=tau, yin=y, param=param, kmode=kmode, lmaxg=lmaxg, lmaxgp=lmaxgp, lmaxr=lmaxr, lmaxnu=lmaxnu, nqmax=nqmax ) 
    )
...
def evolve_perturbations( *, omegam : float, omegab : float, param, aexp_out, kmin : float, kmax : float, num_k : int, \
    ...
    y0 = adiabatic_ics( omegam=omegam, omegab=omegab, tau=tau_start, param=param, kmodes=kmodes, num_k=num_k, nvar=nvar, 
                       lmaxg=lmaxg, lmaxgp=lmaxgp, lmaxr=lmaxr, lmaxnu=lmaxnu, nqmax=nqmax )
    
    # solve ODEs 
    y1 = jax.vmap(
        lambda k_y0 : evolve_one_mode( omegam=omegam, omegab=omegab, y0=k_y0[1:], tau_start=tau_start, tau_max=tau_max, tau_out=tau_out, 
